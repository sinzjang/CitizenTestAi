...
console.log('=== Chinese 파일 구조적 문제 상세 분석 ===\n');
  ...
  chineseData.forEach((question, index) => {
    ...
    if (hasProblems) {
      ...
      problemQuestions.push({
        id: question.id,
        question: question.question_zh || question.question,
        correctCount,
        problems: problemDetails
      });
      
      console.log(`❌ 질문 ${question.id}: "${(question.question_zh || question.question).substring(0, 60)}..."`);
