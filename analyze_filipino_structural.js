...
console.log('=== Filipino 파일 구조적 문제 상세 분석 ===\n');
  ...
  filipinoData.forEach((question, index) => {
    ...
    if (hasProblems) {
      ...
      problemQuestions.push({
        id: question.id,
        question: question.question_tl || question.question,
        correctCount,
        problems: problemDetails
      });
      
      console.log(`❌ 질문 ${question.id}: "${(question.question_tl || question.question).substring(0, 60)}..."`);
