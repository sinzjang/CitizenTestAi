...
def convert_csv_to_json(csv_file_path, json_file_path, backup_dir):
    ...
    with open(csv_file_path, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            question_text = row['Question']  # 스페인어는 'Question'
...
def main():
    print("=" * 60)
    print("🎯 128문제 스페인어 CSV → JSON 변환 도구")
    print("=" * 60)
    ...
    csv_file = data_dir / 'Completed' / 'Complete_128_Questions - Spanish.csv'
    json_file = data_dir / 'interview_questions_es.json'
